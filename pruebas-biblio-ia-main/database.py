...
def init_db():
    ...
    c.execute("""CREATE TABLE IF NOT EXISTS chat_historial (
        ...
        nombre_chat TEXT DEFAULT NULL,
        fecha TIMESTAMP DEFAULT CURRENT_TIMESTAMP
    )""")
    # Migrar nombre_chat si no existe
    try:
        c.execute("ALTER TABLE chat_historial ADD COLUMN IF NOT EXISTS nombre_chat TEXT DEFAULT NULL")
    except Exception:
        pass
